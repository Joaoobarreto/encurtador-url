...
1. **Fork** o projeto
2. **Create** uma branch para sua feature (`git checkout -b feature/AmazingFeature`)
...
- Siga a **estrutura em camadas** do projeto
...
**Gabriel** - [@seu_github](https://github.com/seu-usuario)
